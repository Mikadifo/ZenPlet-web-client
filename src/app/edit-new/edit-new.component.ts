...
export class EditNewComponent implements OnInit {
  ...
  constructor(
    ...
    this.translate
      .get(['data.missing','findPet','confirmDltVaccine','petHaveVaccine','petVacUpdate','selectedPetVaccine','errorOcurred','noHavePets', 'lostPet','lostPetUpdated','errorPost','petInserted','','pwsUpdated','petUpdated','dataSame','dataChange','oldPswIncorrect','confirmDltAccount','pswNoSame','accountDlt','petDlt','confirmDltPet'])
      .subscribe((values) => {
        console.log(values);
